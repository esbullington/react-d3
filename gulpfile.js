...
gulp.task("default", function() {
  ...
  // console.log("gulp minified    -> Compile the javascript with entry as src/index.js and create dist/public/js/react-d3.min.js"); Currently broken, use npm minified run task
